...
import 'package:minified_commerce/src/products/hooks/fetch_similar_products.dart';
...
class SimilarProducts extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final categoryId = context.read<ProductNotifier>().product?.category;

    if (categoryId == null) {
      return const Center(
        child: Text('Category ID is null'),
      );
    }

    final result = fetchSimilarProducts(categoryId);
