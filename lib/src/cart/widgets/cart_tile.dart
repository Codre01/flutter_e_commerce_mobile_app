...
class CartTile extends StatelessWidget {
  const CartTile({super.key, required this.cart, this.onRemove, this.onUpdate});
        ...
        child: Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: !cartNotifier.selectedCartsItemsId.contains(cart.id) ? Kolors.kWhite : Kolors.kPrimaryLight.withOpacity(.2),
